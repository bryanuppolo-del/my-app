...
<ul>
    ...
    <div class="settings">
        <ul>
            ...
            <li><Icon icon="solar:settings-linear" width="24" height="24" />Impostazioni</li>
            <li class="logout"><Icon icon="material-symbols:logout" width="24" height="24" />Logout</li>
        </ul>
    </div>
...
<style>
    .sidebar{
        ...
        box-shadow: 35px 35px 100px 10px rgba(0, 0, 0, 0.06);
    }
